...
//Queues
//Q1 = Interactive Process having Medium Priority with Priority Based Sorting
//Q2 = System Process having High Priority with Round Robin Algorith Quantum Time=4
int q1_n=0,q2_n=0,n=0; //N=Total Process
